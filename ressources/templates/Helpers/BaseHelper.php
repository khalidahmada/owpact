<?php
    /*!
    ************************************** Please don't add nothing here this Will override on next update Owpact *****
    * If you need create you own helper just run your helpers *********************************************************
     * ****************************************************************************************************************
    * User: khalid ahmada
    ...
    **/
    ...
    /**
     * Return the Id of page by template name
     * @param $tpl
     * @return bool
     */
    function getPageIdByTemplatePage($tpl)
    {

        $data=getPageByTemplatedatas($tpl);
...
function tesms_to_string($id, $taxonomie,$split=" ")
{
    ...
    **/
    ...
    /**
     * get template from template parts
     * @param $tpl
     * @param array $data
     * @param bool $return
     * @return bool|string
     */
    function tpl_render($tpl, $data=array(), $return=false)
    {
        return render("template-parts/$tpl.php", $data, $return);
    }
